...
module.exports = {
  'FOA Accepted' : function (browser) { converter.on("end_parsed", function (jsonArray) { for (i = 0; i < jsonArray.length ; i ++)  { 
      ...
      browser
        ...
        .click("//select[@name='acceptVO.aceptOrg']/option[@value='29211267']")
        //受理單位 9455727中彰督導區盛達營業處 29211267極光6JCB 29211264青玉 16610407全心  
        .pause(2000)
        ...
        .elementIdDisplayed("//input[@name='coverage.stdPremAf']", function(){
          for (k=0;k<2;k++){
            !function outer(k) { 
                  browser
                  .setValue("//input[@name='planVO["+k+"].registerCode_text']", jsonArray[i]['planner'+k])
        ...
        //業務員done
        //console.log(browser.elementActive())
        ...
        .waitForElementPresent("//input[@name='aceptOrg_text']", 10000) 
        .clearValue("//input[@name='aceptOrg_text']")
        .setValue("//input[@name='aceptOrg_text']",jsonArray[i]['unit'])
        .click("(//input[@classname='button btn'])[position()=1]")
        ...
        .clearValue("//input[@name='policyHolderBirthDay_minguo']")
        .pause(1000)
        .setValue("//input[@name='policyHolderBirthDay_minguo']", '070/01/01')
        //.setValue("//input[@name='policyHolderGender_text']", '1')
        .clearValue("//input[@name='policyHolderJobCateId_text']")
        .setValue("//input[@name='policyHolderJobCateId_text']", 'A101')
        .clearValue("//input[@name='policyHolderJobClass']")
        ...
        .setValue("//input[@name='insured.nbInsuredCategory']", '1')
        //.setValue("//input[@name='insured.relationToPH_text']", '0')
        .pause(1000)
        .clearValue("//input[@name='insured.marriageId_text']")
                  ...
                  .pause(1000)          
                    .getAttribute("//input[@name='coverage.initialType_text']", "value" ,function(result){
                     if (result.value == '00'){
                      ...
                      console.log(k)
                      browser
                        .clearValue("//input[@name='coverage.chargePeriod_text']")
                        .setValue("//input[@name='coverage.chargePeriod_text']", jsonArray[i]['addperiod'+k])
                        .clearValue("//input[@name='coverage.chargeYear']")
                    ...
                    .getAttribute("//input[@name='coverage.benefitLevel']", "class" ,function(result){
                       if (result.value == 'textfiled textfield_null readOnly ro'){} else {
                        browser
                          .clearValue("//input[@name='coverage.benefitLevel']")
